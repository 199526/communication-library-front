...
import { ChatAdapter, createAzureCommunicationChatAdapterFromClient } from '@azure/communication-react';
import { _createStatefulChatClientWithDeps } from '@internal/chat-stateful-client';
import { FakeChatService } from '@internal/react-composites';
...
export const setupFakeThreadWithTwoParticipants = async (
  ...
  console.log(`firstUserId: ${JSON.stringify(firstUserId)}, secondUserId: ${JSON.stringify(secondUserId)}`);
